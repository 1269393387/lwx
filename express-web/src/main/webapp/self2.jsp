...
<!-- main begin-->
 ...
 <table>
<tr><td>用户名：<input type="text" value="test1"></input></td></tr>
<tr><td>密    码：<input type="text" value="00000"></input></td></tr>
<tr><td>电    话：<input type="text" value="1893123158"></input></td></tr>
<tr><td>地    址：<input type="text" value="广东省深圳市"></input> </td></tr>
